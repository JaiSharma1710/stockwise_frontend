...
const Detail = () => {
  ...
  const [chartLoading, isChartLoading] = useState(true);
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const intradayData = await axios.get(
        `${baseUrl}/quote/intraday?symbol=${companySymbol}`
      );
      updateChartData(intradayData);
  ...
  return (
    <div className="w-full px-6 py-10">
      ...
      {chartLoading ? <p>loading..........</p> : <Chart data={chartData} />}
